...
import SignleListProduct from "../components/SignleListProduct";
...
const ProductsList = () => {
	...
	return (
		<div className="px-4 xl:container mx-auto">
					...
					<div className="bg-c1h border border-c1d rounded-xl px-4 py-2 w-fit flex gap-4">
						<div className="flex gap-2 ">
							<input
								type="checkbox"
								checked
								onChange={() => console.log("filte changed")}
							/>
							<p className="text-sm">
								Filter{" "}
			...
			{/* LIST VIEW */}
			<div className="flex flex-col lg:flex-row gap-8 xl:gap-16 py-8 xl:py-16">
				{/* LEFT FILTER DETAILS */}

...
const BlogDetails = () => {
	const [showBlogDetailsError, setShowBlogDetailsError] = useState(false);
	...
	return (
		<div className="px-4 xl:container xl:mx-auto">
			...
			{blog._id.length === 0 && !showBlogDetailsError && (
				<div className="mx-auto w-fit">
					<DummyProduct />
				</div>
			)}

			{showBlogDetailsError && (
				<div className="border border-gray-500 rounded-xl w-full py-36 px-3 bg-gray-200">
					<div className="mx-auto my-auto w-fit text-center">
						<ErrorMessage message="Blog details fetching failed. Connection refused from Backend." />
					</div>
				</div>
			)}
						...
						<div className="w-320 sm:w-569">
							<div className="pb-12">
								...
								<div className="mb-12">
									...
									<p className="text-17">
										Want that extra morning energy without
										the caffeine jitters? Switch out your
										morning mug of coffee for a warm,
										energizing cup of{" "}
										<span className="underline">
											earl grey
										</span>
										. Serve as is or stir in some milk and
										honey for extra coziness. If you want to
										spice things up, try chai tea instead!
										The combination of{" "}
										<span className="underline">
											cinnamon
										</span>
										...
										smells amazing and gives you that nice
										little flavor kick to start your day off
										right.
									</p>
								</div>
								...
								<div className="mb-12">
									...
									<p className="text-17 mb-4">
										...
										post-lunch, beat the afternoon slump
										with some lemon ginger green tea.
										<span className="underline">
											Green tea
										</span>{" "}
										can be a great alternative to coffee in
										the afternoon when you want that little
										boost of energy. An added benefit: lemon
										and ginger work together to aid
										digestion which is especially helpful
										after lunch.{" "}
									</p>
									<p className="text-17 mb-8">
										If you’re not into hot drinks, opt-in
										for a fruity iced green tea instead.
										Steep some honeydew or peach green tea
										in hot water for a few minutes and then
										pour over ice until it’s nice and cool.
										Enjoy with a slice of lemon, and you’ll
										feel refreshed and ready to tackle any
										task.{" "}
									</p>
								</div>
								...
								<div className="mb-12">
									...
									<p className="text-17">
										Slip on some fuzzy socks, light your
										favorite candles, and fire up the
										kettle—it’s time to wind down after a
										long day. Grab yourself a soothing cup
										of lavender{" "}
										<span className="underline">
											chamomile
										</span>{" "}
										tea and indulge in some well-deserved
										self-love.
									</p>
								</div>
							...
							<div className="py-12">
								...
								<div className="mb-12 flex flex-col gap-8 w-320 sm:w-569">
									...
									<div className="bg-c1h border border-c1d rounded-xl w-fit px-4 py-2 flex items-center gap-3">
										...
										/>
										<p className="text-sm">
											Save my name and email in this
											browser for a next time comment.
										</p>
									</div>
